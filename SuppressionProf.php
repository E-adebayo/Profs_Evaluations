                            ...
                            <div class="content">
                                <form method="POST" action="Suppression.php">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary btn-fill " ><a href="Administrateur.php" style="color: white">Annuler</a></button>&nbsp;&nbsp;&nbsp;
                                                <button type="submit" class="btn btn-primary btn-fill " name="supprimer"><a href="Administrateur.php"  style="color:white" >Supprimer</a></button>
                                            </div>
                                        </div>
                                    </div>
...
$classe=$_POST['classe'];
    ...
    $req = $con->prepare("DELETE FROM `professeur` WHERE `Code_PROF` = '$Code_PROF'  ");
    $req->execute();

    // $req1 = $con->prepare("DELETE FROM `intervenir`WHERE `FK_Code_CLASSE`='$classe' and`FK_Code_PROF`='$Code_PROF' and`FK_Code_UE`='$ue' ");
    // $req1->execute();

    // $req2 = $con->prepare("DELETE FROM `enseigner`WHERE `FK_Code_EC`='$ec' and`FK_Code_UE`='$ue' and`FK_Code_PROF`='$Code_PROF' ");
    // $req2->execute();
