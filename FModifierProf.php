                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: white">
                            <div class="header">
                                <h4 class="title"align="center">Modifier un professeur</h4>
                            </div>
                            <div class="content">
                                <form method="POST" >
                                    <div class="row" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-fill " name="modifier"><a href="Administrateur.php"  style="color:white" >Modifier</a></button>
                                            </div>
                                        </div>
                                    </div>
...
if(isset($_POST['modifier'])){
    ...
    $req->execute();
    $req1 = $con->prepare(" UPDATE `intervenir` SET `FK_Code_CLASSE`=$classe , `FK_Code_UE`=$ue WHERE `FK_Code_PROF`='$Code_PROF'");
    $req1->execute();
    $req2 = $con->prepare(" UPDATE `enseigner` SET`FK_Code_EC`=$ec, `FK_Code_UE=$ue` WHERE `FK_Code_PROF`='$Code_PROF'");
    $req2->execute();
