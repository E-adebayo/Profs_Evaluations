                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: white">
                            <div class="header">
                                <h4 class="title"style="text-align: center;">Ajouter une UE</h4>
                            </div>
                            <div class="content">
                                <form method="POST" >
                                    <div class="row" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit" class="btn btn-primary btn-fill" ><a href="AffichageUE.php" style="color: white">Annuler</a></button>&nbsp;&nbsp;&nbsp;
                                                <button type="submit" class="btn btn-primary btn-fill " name="ajouter"><a href="AffichageUE.php" style="color:white" >Valider</a></button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
                                    </div><br><br>
...
$con = $ac->connection();
 ...
 if(isset($_POST['ajouter'])) {
    ...
    $req = $con->prepare(" INSERT INTO `ue`(`Code_UE`, `Libelle_UE`) VALUES ('$Code_UE','$Libelle_UE')");
    $req->execute();
