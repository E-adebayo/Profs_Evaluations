                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: white">
                            <div class="header">
                                <h4 class="title"style="text-align: center;">Modifier une UE</h4>
                            </div>
                            <div class="content">
                                <form method="POST" >
                                    <div class="row" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit" class="btn btn-primary btn-fill" ><a href="AffichageUE.php" style="color: white">Annuler</a></button>&nbsp;&nbsp;&nbsp;
                                                <button type="submit" class="btn btn-primary btn-fill " name="modifier"><a href="AffichageUE.php" style="color:white" >Modifier</a></button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
                                    </div><br><br>
