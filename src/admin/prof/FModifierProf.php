                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: white">
                            <div class="header">
                                <h4 class="title"style="text-align: center;">Modifier un professeur</h4>
                            </div>
                            <div class="content">
                                <form method="POST" >
                                    <div class="row" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-fill " name="modifier"><a href="AffichageProf.php"  style="color:white" >Modifier</a></button>
                                            </div>
                                        </div>
                                    </div>
