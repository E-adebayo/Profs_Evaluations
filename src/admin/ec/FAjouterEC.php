                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: white">
                            <div class="header">
                                <h4 class="title" style="text-align: center;">Ajouter une EC</h4>
                            </div>
                            <div class="content">
                                <form method="POST" >
                                    <div class="row" >
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label " for="Code_EC" >Code_EC:</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label " for="Libelle_EC">Libelle_EC:</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit" class="btn btn-primary btn-fill" ><a href="AffichageEC.php" style="color: white">Annuler</a></button>&nbsp;&nbsp;&nbsp;
                                                <button type="submit" class="btn btn-primary btn-fill " name="ajouter"><a href="AffichageEC.php" style="color:white" >Valider</a></button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
                                    </div><br><br>
