                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="background-color: white">
                            <div class="header">
                                <h4 class="title" style="text-align: center;">Supprimer une EC</h4>
                            </div>
                            <div class="content">
                                <form method="POST" >
                                    <div class="row" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <button type="submit" class="btn btn-primary btn-fill" ><a href="AffichageUE.php" style="color: white">Annuler</a></button>&nbsp;&nbsp;&nbsp;
                                                <button type="submit" class="btn btn-primary btn-fill " name="supprimer"><a href="AffichageEc.php" style="color:white" >Supprimer</a></button>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
                                    </div><br><br>
...
$Code_EC = $_POST['Code_EC'];
    ...
    $req = $con->prepare("DELETE FROM `ec` WHERE `Code_EC` = '$Code_EC' ");
    $req->execute();
