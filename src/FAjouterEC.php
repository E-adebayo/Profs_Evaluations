...
if (isset($_POST['ajouter'])) {
    ...
    try {
        $stmt = $con->prepare("INSERT INTO ec (Code_EC, Libelle_EC) VALUES (:code, :libelle)");
        $stmt->execute([
            'code' => $code_ec,
            'libelle' => $libelle_ec
        ]);
        ...
        $error = "Une erreur est survenue lors de l'ajout de l'EC.";
    }
}
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <title>Ajouter un EC - IAI-TOGO</title>
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        ...
        <div class="col-md-3">
            <ul class="nav justify-content-end">
                <li class="nav-item">
                    <h5 class="nav-link text-white">Ajout d'un EC</h5>
                </li>
            </ul>
        </div>
    </nav>
